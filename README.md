...
```
git clone https://github.com/AlexVasilev25/Data_Cleaning_Project
```
...
Данный проект по очистке данных быд проведен с целью демонстрации различных методов очистки данных. Цель такого проекта, показать насколько важен процесс очистки, что очистка данных является важной частью анализа данных. Правильная очистка данных позволяет построить более точную и качественную модель прогнозирования.